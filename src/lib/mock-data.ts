export const MOCK_TRACKS = [
  {
    ...
    categories: [
      "DeFi e Infraestructura Financiera",
...
export const MOCK_TRACK_DETAILS: Record<string, any> = {
  "arbitrum-track": {
    ...
    formation: {
      description:
        "Tanto si eres nuevo en Web3 como si ya desarrollas contratos inteligentes avanzados, aquí encontrarás el camino para construir sobre Arbitrum. Sigue los niveles en orden o ve directo al que corresponda a tu experiencia.",
      levels: [
        {
          level: "Principiante",
          badge: "01",
          ...
          resources: [
            {
              ...
              description:
                "Una guía amigable que explica por qué Ethereum necesita soluciones de escalabilidad y cómo Arbitrum resuelve ese problema.",
              url: "https://docs.arbitrum.io/get-started/arbitrum-introduction",
            },
            {
              title: "Tutorial del Puente de Arbitrum",
              description:
                "Guía paso a paso para conectar tu billetera y transferir fondos desde Ethereum de forma segura.",
              url: "https://docs.arbitrum.io/arbitrum-bridge/quickstart",
            },
            {
              title: "Portal de Arbitrum",
              description:
                "Catálogo oficial para descubrir aplicaciones, juegos y herramientas verificadas y activas en la red.",
          ...
          resources: [
            {
              ...
              description:
                "Tutoriales gamificados enfocados en Arbitrum donde realizas acciones reales en la blockchain y acumulas experiencia.",
              url: "https://layer3.xyz/",
            },
            {
              title: "L2BEAT — Panel de seguridad",
              description:
                "La referencia de la industria para auditar la seguridad de una Capa 2, revisar sus riesgos y verificar el TVL bloqueado.",
              url: "https://l2beat.com/scaling/projects/arbitrum",
            },
            {
              title: "Arbiscan — Explorador de la red",
              description:
                "Rastrea el estado de tus transacciones, saldos de billeteras y costos exactos de gas directamente en la red.",
          ...
          resources: [
            {
              ...
              description:
                "Tutorial oficial desde cero para compilar y desplegar tu primer contrato inteligente usando la herramienta online Remix.",
              url: "https://docs.arbitrum.io/build-decentralized-apps/quickstart-solidity-remix",
            },
            {
              title: "Foundry en Arbitrum",
              description:
                "Comandos y estructura para crear, compilar y verificar un contrato o token ERC-20 usando Foundry como entorno de desarrollo.",
          ...
          resources: [
            {
              ...
              description:
                "Desde instalar cargo-stylus hasta compilar tu código a WASM y desplegarlo en la red. El punto de partida definitivo.",
              url: "https://docs.arbitrum.io/stylus/quickstart",
            },
            {
              title: "Stylus Rust SDK — Referencia completa",
              description:
                "Domina el manejo de storage y la optimización de gas en Rust para sacar el máximo rendimiento de tus contratos Stylus.",
