    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 max-w-3xl">
        ...
        >
          ...
          <div className="font-mono text-xs text-green-400 mb-3 tracking-[0.3em] uppercase">
            {"// Mentor Application"}
          </div>
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-xl">
            Share your expertise in Smart Contracts, UX, or Business and help builders turn ideas
            into protocols.
          </p>
                ...
                {[
                  ...
                  <div key={l}>
                    ...
                    <input
                      required
                      placeholder={ph}
                      className="w-full h-10 px-3 rounded-lg bg-white/5 border border-white/10 text-sm placeholder:text-gray-700 focus:outline-none focus:border-green-500/50 transition-all"
                    />
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-xl border border-white/8 bg-white/2 p-6 space-y-4">
              ...
              <div>
                ...
                <select className="w-full h-10 px-3 rounded-lg bg-white/5 border border-white/10 text-sm text-gray-300 focus:outline-none focus:border-green-500/50 transition-all appearance-none">
                  {["< 1 year", "1-2 years", "3-5 years", "5+ years"].map((o) => (
              ...
              <div>
                <label className="text-xs text-gray-500 block mb-3">Areas of Expertise</label>
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <label
                      key={area}
                      className="flex items-center gap-2 p-2 rounded-lg border border-white/5 bg-white/2 text-[11px] text-gray-400 cursor-pointer hover:bg-white/5 has-[:checked]:border-green-500/50"
                    >
              ...
              <div>
                <label className="text-xs text-gray-500 block mb-1.5">
                  Why do you want to mentor at ETH Lima?
                </label>
                <textarea
                  rows={3}
                  placeholder="Tell us about your previous mentorship experience..."
                  className="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-sm placeholder:text-gray-700 focus:outline-none focus:border-green-500/50 transition-all resize-none"
                />
              </div>
            </div>
