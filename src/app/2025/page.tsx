...
export default function Edition2025Page() {
  ...
  const judges = [
    ...
    {
      name: "Alan Espinoza",
      role: t("edition2025.roles.jurado"),
      img: "/2025/judge/alan-espinoza.webp",
    },
    {
      name: "Angel Espinoza",
      role: t("edition2025.roles.jurado"),
      img: "/2025/judge/angel-espinoza.webp",
    },
    { name: "Solene", role: t("edition2025.roles.jurado_virtual"), img: "/2025/judge/solene.webp" },
    {
      name: "Stella Achenbach",
      role: t("edition2025.roles.jurado_virtual"),
      img: "/2025/judge/stella.webp",
    },
    {
      name: "Arturo Mena",
      role: t("edition2025.roles.jurado_tecnico"),
      img: "/2025/judge/arturo.webp",
    },
    {
      name: "Javier Arteaga",
      role: t("edition2025.roles.jurado_tecnico"),
      img: "/2025/judge/javier.webp",
    },
  ];
    ...
    <div className="min-h-screen bg-bg text-fg selection:bg-coral/30 overflow-x-hidden font-sans transition-colors duration-300">
      <nav className="sticky top-0 w-full z-50 border-b border-border bg-surface/75 backdrop-blur-xl transition-all duration-300">
        ...
        <div className="w-full border-t border-border/50 bg-surface/90 backdrop-blur-md hidden md:block">
          <div className="container mx-auto px-6 h-12 flex items-center justify-center gap-8 text-sm font-medium">
            <a href="#recap" className="text-fg/60 hover:text-brand-accent transition-colors">
              {t("edition2025.nav.recap")}
            </a>
            <a href="#winners" className="text-fg/60 hover:text-brand-accent transition-colors">
              {t("edition2025.nav.winners")}
            </a>
            <a href="#judges" className="text-fg/60 hover:text-brand-accent transition-colors">
              {t("edition2025.nav.judges")}
            </a>
            <a href="#organizers" className="text-fg/60 hover:text-brand-accent transition-colors">
              {t("edition2025.nav.organizers")}
            </a>
            <a href="#gallery" className="text-fg/60 hover:text-brand-accent transition-colors">
              {t("edition2025.nav.gallery")}
            </a>
          </div>
        </div>
      </nav>
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="mb-12">
          <Link
            href="/"
            className="inline-flex items-center text-fg/60 hover:text-brand-accent transition-colors mb-6 text-sm"
          >
          ...
          >
            ...
            <p className="text-xl text-fg/70 mb-12">{t("edition2025.description")}</p>
            ...
            <div className="bg-surface border border-border rounded-2xl p-6 md:p-8 text-left mb-12 shadow-lg">
              ...
              <ul className="space-y-3 text-fg/80">
                <li className="flex items-start gap-2">
                  <span className="text-brand-accent">•</span> {t("edition2025.dates.reg")}
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-brand-accent">•</span> {t("edition2025.dates.hack")}
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-brand-accent">•</span> {t("edition2025.dates.pitch")}
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-brand-accent">•</span> {t("edition2025.dates.eval")}
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-brand-accent">•</span> {t("edition2025.dates.winners")}
                </li>
              </ul>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="flex flex-wrap justify-center items-center gap-12 opacity-80 hover:opacity-100 transition-opacity">
                ...
                <Image
                  ...
                  width={200}
                  height={64}
                  className="h-12 md:h-16 w-auto object-contain grayscale invert dark:invert-0"
                />
              </div>
            </div>
          </motion.div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center group-hover:bg-black/20 transition-colors duration-500">
                  <motion.div
                    animate={{
                      boxShadow: [
                        "0px 0px 0px 0px rgba(0,240,255,0.7)",
                        "0px 0px 0px 20px rgba(0,240,255,0)",
                      ],
                    }}
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-4">
            <h2 className="text-3xl font-bold">{t("edition2025.tracks")}</h2>
            <a
              href={t("edition2025.taikai_url")}
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 bg-brand-accent text-bg px-5 py-2.5 rounded-full font-semibold hover:bg-brand-accent/90 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {tracks.map((track, idx) => (
              ...
              >
                <div
                  className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${track.color} opacity-10 blur-3xl rounded-full group-hover:opacity-20 transition-opacity`}
                />
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="text-fg/70 text-sm leading-relaxed mb-6 flex-grow">{track.desc}</p>

                  <a
                    href={track.link}
                    target="_blank"
                    rel="noreferrer"
                    className="mt-auto inline-flex items-center justify-center gap-2 w-full py-3 bg-surface border border-border rounded-xl font-medium text-sm hover:bg-brand-accent hover:text-bg hover:border-brand-accent transition-all z-20 relative"
                  >
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              {t("edition2025.judges_title") || "Jurados"}
            </h2>
            <p className="text-fg/60">
              {t("edition2025.judges_desc") || "Conoce a los expertos que evaluaron los proyectos."}
            </p>
          </div>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-10">
            {[
              {
                name: "Javier Arteaga",
                role: t("edition2025.organizers_lead"),
                img: "/2025/organizer/javier.webp",
              },
              {
                name: "Criss Valladares",
                role: t("edition2025.organizers_member"),
                img: "/2025/organizer/criss-valladares.webp",
              },
              {
                name: "Yamille Celis",
                role: t("edition2025.organizers_member"),
                img: "/2025/organizer/yami.webp",
              },
            ].map((org, idx) => (
              <motion.div
                key={org.name}
