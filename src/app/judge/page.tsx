    ...
    return (
      <div className="flex h-screen bg-black text-white font-sans overflow-hidden">
        <aside className="w-64 border-r border-white/5 flex flex-col shrink-0 bg-[#080808]">
          <div className="p-6 border-b border-white/5"><div className="h-7 w-24 bg-white/5 animate-pulse rounded" /></div>
        </aside>
    ...
    <div className="flex h-screen bg-black text-white font-sans overflow-hidden">
      ...
      <aside className="w-64 border-r border-white/5 flex flex-col shrink-0 bg-[#080808]">
        ...
        <div className="p-6 border-t border-white/5 space-y-4">
          ...
          <button onClick={() => signOut({ callbackUrl: "/" })} className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-xs text-gray-500 hover:text-red-400 hover:bg-red-400/5 transition-all">
