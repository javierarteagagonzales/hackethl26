    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 border-r border-white/10 bg-black/20 flex flex-col sticky top-0 md:h-screen shrink-0">
        ...
        <div className="flex-1 px-4 py-2 space-y-1">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-3 py-2 rounded-md bg-white/10 text-white font-medium"
          >
            <LayoutDashboard className="w-4 h-4" /> Dashboard
          </Link>
          <Link
            href="/dashboard/team"
            className="flex items-center gap-3 px-3 py-2 rounded-md text-muted-foreground hover:text-white hover:bg-white/5 transition-colors"
          >
