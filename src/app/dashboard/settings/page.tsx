  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans p-6 md:p-12">
      <div className="max-w-2xl mx-auto space-y-8">
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-2 text-gray-500 hover:text-white transition-colors text-sm mb-4 group"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <section className="bg-white/2 border border-white/8 rounded-xl p-6 space-y-4">
            <h2 className="text-xs font-mono text-gray-500 uppercase tracking-widest flex items-center gap-2">
              <UserIcon className="w-3 h-3" /> 01. General Info
            </h2>
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Developer passionate about L2s..."
          ...
          <section className="bg-white/2 border border-white/8 rounded-xl p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    placeholder="octocat"
                    className="flex-1 h-11 px-4 rounded-r-lg bg-black border border-white/10 text-sm focus:outline-none focus:border-blue-500/50 transition-all"
                  />
                </div>
              </div>
              <div className="space-y-1.5">
            ...
            <div>
              <label className="text-xs text-gray-500 block mb-1.5 ml-1 flex items-center gap-1.5">
              ...
              <input
                ...
                placeholder="0x..."
                className="w-full h-11 px-4 rounded-lg bg-black border border-white/10 text-sm font-mono focus:outline-none focus:border-blue-500/50 transition-all"
              />
            </div>
          </section>
          ...
          <button
            type="submit"
            disabled={saving}
            className="w-full h-12 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
          >
